...
public class RecipeSearch extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        //Debugging FXML
        System.out.println(java.util.ResourceBundle.getBundle("recipesearch/resources/RecipeSearch"));
        System.out.println(getClass().getResource("recipe_search.fxml"));
        ...
        stage.sizeToScene();
        stage.getIcons().add(new Image("recipesearch/resources/logo.png"));
